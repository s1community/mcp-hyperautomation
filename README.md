...
- **[DB Agent](./agents/DB_Agent/README.md)** - Temporarily stores data returned by any of the Agents above in a temporary database in the Cloud

### Cloud DB
This component handles the retrieval of results generated by the HA Agents via polling
- While the code included in this repo leverages [Google Big Query](https://cloud.google.com/bigquery) as DB to temporarily store results, you can use any other cloud DB of you choice, provided that:
